 ...
 *$_POST, $_GET o bé $_REQUEST. Aquesta variable és un vector associatiu que utilitza
*els noms (name) dels inputs del formulari com a índexs i en cada índex
*guarda el valor assignat al nom (name) de l'input corresponent. */
...
//Mostrem el contingut del vector associatiu $_GET o $_POST depèn del 
...
print_r($_REQUEST); // No s'afegeix cap dels elements afegits amb GET o POST
echo"</p>";
