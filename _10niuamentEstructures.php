...
echo "<h3>ESTRUCTURES ITERATIVES NIUADES</h3>"; //Títol secció

//Creació d'una taula HTML de 12 x 12 de manera dinàmica

echo "<table style=\"border: 1px solid #000;\">"; //Obrim taula amb estil
...
for ($fila=1; $fila<=12; $fila++) { 
	...
	//Construïm les cel.les de la fil.la oberta
