<?php	
     ...
     *i opcionalment longitud amb la cadena "substitut".
     *El paràmetre inici és un nombre enter. Si és positiu, el reemplaçament
     *s'iniciarà en la posició de la cadena que coincideixi amb aquest número.
     *Si és negatiu, el reemplaçament s'iniciarà en la posició de la cadena
     *que coincideixi amb aquest número començant pel final de la cadena.
     *Si no indiquem longitud es realitzarà la substitució fins a arribar al
