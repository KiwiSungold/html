...
do{ //realitzem...
	...
	echo "El nombre és: $nombre<br/>"; //...aquesta acció...
	
	$nombre++;//...augmentem en 1 el comptador...
	
}while (($nombre > 200) && ($nombre < 400)); //...mentre es compleixi aquesta condició
...
echo "<p>Final de l'script amb nombre = $nombre.</p>"; //... es realitza aquesta acció
