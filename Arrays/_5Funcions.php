...
/* La funció in_array(valor, array), retorna verdader si valor es troba en l'array*/
$valor = "Sally";
...
/* La funció array_key_exists(clau, array), retorna verdader si la clau es troba en l'array*/
$valor = "nom";
